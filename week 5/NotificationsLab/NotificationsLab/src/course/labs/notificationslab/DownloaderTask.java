				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (/*change this*/ true) {
							...
							mContentView.setTextViewText(R.id.text, message); 
							...
							//mContentView.setTextViewText(android.R.id.text1, successMsg);
							...
							NotificationManager nm = (NotificationManager) mApplicationContext.getSystemService(Context.NOTIFICATION_SERVICE);
							 Notification.Builder notificationBuilder = new Notification.Builder(mApplicationContext);                                      
							                 notificationBuilder.setContentIntent(pendingIntent)
							                         .setContentTitle("Twitter App")
							                         .setContentText("twitter app message :p")
							                         .setSmallIcon(android.R.drawable.stat_sys_warning)
							                         .setAutoCancel(true);
							                
							                 Notification n = notificationBuilder.build();
							                 nm.notify(MY_NOTIFICATION_ID, n);
